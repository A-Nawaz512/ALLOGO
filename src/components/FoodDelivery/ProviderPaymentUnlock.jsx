      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            Provider <span className="bg-gradient-to-r from-[#F5B45D] to-[#FACC15] bg-clip-text text-transparent">Requirements</span>
          </h2>
        ...
        <div className="bg-white border border-gray-200 rounded-3xl shadow-xl p-10 flex flex-col items-center text-center space-y-6">
          <div className="p-6 bg-gradient-to-r from-[#F5B45D] to-[#FACC15] rounded-full inline-flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mt-8 w-full">
            <div className="flex items-center gap-3 p-4 bg-gray-100 rounded-xl hover:bg-gray-200 transition">
              <Lock className="w-6 h-6 text-[#F5B45D]" />
              <span>Secure access to delivery tasks</span>
            </div>
            <div className="flex items-center gap-3 p-4 bg-gray-100 rounded-xl hover:bg-gray-200 transition">
              <Shield className="w-6 h-6 text-[#F5B45D]" />
              <span>Encrypted card information</span>
            </div>
            <div className="flex items-center gap-3 p-4 bg-gray-100 rounded-xl hover:bg-gray-200 transition">
              <CheckCircle className="w-6 h-6 text-[#F5B45D]" />
              <span>Unlock deliveries instantly after verification</span>
            </div>
            <div className="flex items-center gap-3 p-4 bg-gray-100 rounded-xl hover:bg-gray-200 transition">
              <CreditCard className="w-6 h-6 text-[#F5B45D]" />
              <span>Supports multiple card types</span>
            </div>
          </div>

          {/* CTA */}
          <button className="mt-10 bg-gradient-to-r from-[#F5B45D] to-[#FACC15] text-white px-8 py-3 rounded-full font-semibold hover:shadow-lg transition">
            Verify Your Card
          </button>
        </div>
      </div>
