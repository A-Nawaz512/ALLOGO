    ...
    <div>
      ...
      <div className="mb-8" data-aos="fade-down">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-3">
          Send us a <span className="bg-gradient-to-r from-[#6F4918] to-[#E2CF7D] bg-clip-text text-transparent">Message</span>
        </h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Submit Button */}
        <button type="submit" className="group w-full py-4 bg-gradient-to-r from-[#6F4918] to-[#E2CF7D] text-white font-semibold rounded-xl shadow-lg transition-all duration-300 transform hover:-translate-y-1 hover:shadow-xl flex items-center justify-center gap-3">
          Send Message <RiSendPlaneFill className="w-5 h-5 group-hover:translate-x-2 transition-transform duration-300"/>
        </button>
      </form>
    </div>
  );
