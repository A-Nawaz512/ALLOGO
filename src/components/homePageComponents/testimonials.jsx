...
const testimonials = [
  { id: 1, name: "Imen", role: "Ride Customer", image: "🚖", content: "Booked a ride on ALLOGO and the driver arrived in minutes. Smooth, clean, and professional.", rating: 5, achievement: "Top Ride Experience" },
  { id: 2, name: "Rachid", role: "Delivery Sender", image: "🚚", content: "Sent an urgent package across town. ALLOGO delivered it faster than I expected!", rating: 5, achievement: "Express Delivery User" },
  { id: 3, name: "Meriam", role: "Food Lover", image: "🍔", content: "My burger arrived hot and fresh. ALLOGO became my favorite food delivery app!", rating: 4, achievement: "Food Delivery Fan" },
  { id: 4, name: "Sami", role: "Scooter Rider", image: "🛵", content: "Quick scooter booking with great prices. Perfect for quick trips around the city.", rating: 5, achievement: "Urban Rider" },
  { id: 5, name: "Nawal", role: "Grocery Shopper", image: "🛒", content: "Ordered groceries through ALLOGO. Everything arrived packed neatly and right on time.", rating: 5, achievement: "Smart Shopper" },
  { id: 6, name: "Yanis", role: "Home Service Client", image: "🏠", content: "Needed quick assistance at home—ALLOGO connected me instantly with a reliable service provider.", rating: 4, achievement: "Home Helper User" },
  { id: 7, name: "Khaled", role: "Tow Truck Request", image: "🪝", content: "My car broke down on the highway. ALLOGO towing saved the day with fast support!", rating: 5, achievement: "Emergency Rescue" },
  { id: 8, name: "Dina", role: "Key Service User", image: "🔑", content: "Lost my keys and ALLOGO locksmith arrived quickly. Super reliable!", rating: 5, achievement: "Quick Fix Client" },
];
    ...
    <section className="relative bg-white text-black py-28 px-6 overflow-hidden">
      ...
      >
        ...
        <p className="text-gray-700 mt-4 max-w-2xl mx-auto text-lg">
          Real experiences from people who trust ALLOGO’s multi-service ecosystem.
        </p>
      </motion.div>
          ...
          <SwiperSlide key={t.id}>
            ...
            >
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <p className="text-sm uppercase tracking-widest" style={{ color: goldMid }}>
                  {t.role}
                </p>

                <div className="flex gap-1 mt-2">
                  {[...Array(t.rating)].map((_, i) => (
                    <Star key={i} className="w-6 h-6" style={{ color: goldFrom, fill: goldFrom }} />
                  ))}
                </div>
                ...
                >
                  ...
                  <span className="text-sm font-semibold">{t.achievement}</span>
                </div>
              </div>
            </motion.div>
          </SwiperSlide>
