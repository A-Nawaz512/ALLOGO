      ...
      <section className="py-20 px-6 lg:px-8 bg-gray-100 overflow-hidden">
         <div className="max-w-6xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-12 mb-20">
               ...
               >
                  ...
                  <div className="relative bg-white p-8 rounded-2xl border border-gray-200 h-full overflow-hidden transition-all duration-400 group-hover:shadow-xl group-hover:shadow-[#E2CF7D]/20 group-hover:border-[#E2CF7D]/30">
                     ...
                     <p className="text-[#202020] text-lg mb-8 leading-relaxed group-hover:text-[#202020]/90 transition-colors duration-400">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                           {[
                              ...
                              >
                                 ...
                                 <p className="text-gray-600 text-sm hover:text-gray-800 transition-colors duration-400">
                                    {value.desc}
                                 </p>
                              </div>
                           ))}
            ...
            >
               ...
               {/* Summary */}
               <div
                  className="mt-12 text-center transition-all duration-400"
                  data-aos="fade-up"
                  data-aos-delay="900"
                  data-aos-once="true"
                  data-aos-mirror="false"
